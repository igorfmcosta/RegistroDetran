namespace RegistroDetran.Application.DTOs.Contrato
{
    public class AgenteFinanceiro
    {
        ...
        public bool EnvioRelatorioCobranca { get; set; }
        public bool EnvioEmailNaoFaturamento { get; set; }
        public bool UnificarCobranca { get; set; }
        public bool ObservatorioAtivo { get; set; }
